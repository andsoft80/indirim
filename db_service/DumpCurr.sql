...
INSERT INTO `types` VALUES (1,'Авто'),(2,'Компьютеры и ноутбуки'),(3,'Смартфоны'),(4,'Бытовая техника'),(5,'Ювелирные изделия'),(6,'Часы'),(7,'Очки'),(8,'Аксессуары прочие'),(9,'Автозапчасти'),(10,'Подарки'),(11,'Парфюмерия'),(12,'Косметика');
